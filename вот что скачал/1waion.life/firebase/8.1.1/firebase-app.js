/* eslint-disable */ ! function(e, t) {
    ...
    function u(e, t) {
        ...
        try {
            for (;
                (void 0 === t || 0 < t--) && !(n = o.next()).done;) a.push(n.value)
        } catch (e) {
            i = {
                error: e
            }
    ...
    var a, s, l, c = "FirebaseError",
        p = (a = Error, r(s = v, l = a), s.prototype = null === l ? Object.create(l) : (f.prototype = l.prototype, new f), v);
    ...
    var m = (y.prototype.create = function(e) {
        ...
        var n, i = t[0] || {},
            o = this.service + "/" + e,
            e = this.errors[e],
            e = e ? (n = i, e.replace(g, function(e, t) {
                var r = n[t];
    ...
    var L = "[DEFAULT]",
        S = (R.prototype.get = function(e) {
            ...
            try {
                for (var n = h(this.instancesDeferred.entries()), i = n.next(); !i.done; i = n.next()) {
                    var o = u(i.value, 2),
                        a = o[0],
                        s = o[1],
    ...
    var j, D = [];
    (H = j = j || {})[H.DEBUG = 0] = "DEBUG", H[H.VERBOSE = 1] = "VERBOSE", H[H.INFO = 2] = "INFO", H[H.WARN = 3] = "WARN", H[H.ERROR = 4] = "ERROR", H[H.SILENT = 5] = "SILENT";
    ...
    var k = {
        ...
        T = j.INFO,
        x = ((V = {})[j.DEBUG] = "log", V[j.VERBOSE] = "log", V[j.INFO] = "info", V[j.WARN] = "warn", V[j.ERROR] = "error", V),
        H = (Object.defineProperty(z.prototype, "logLevel", {
            get: function() {
            ...
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.DEBUG], e)), this._logHandler.apply(this, C([this, j.DEBUG], e))
        }, z.prototype.log = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.VERBOSE], e)), this._logHandler.apply(this, C([this, j.VERBOSE], e))
        }, z.prototype.info = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.INFO], e)), this._logHandler.apply(this, C([this, j.INFO], e))
        }, z.prototype.warn = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.WARN], e)), this._logHandler.apply(this, C([this, j.WARN], e))
        }, z.prototype.error = function() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            this._userLogHandler && this._userLogHandler.apply(this, C([this, j.ERROR], e)), this._logHandler.apply(this, C([this, j.ERROR], e))
        }, z);

    function z(e) {
        this.name = e, this._logLevel = T, this._logHandler = F, this._userLogHandler = null, D.push(this)
    }
    ...
    var V = ((V = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()", V["bad-app-name"] = "Illegal App name: '{$appName}", V["duplicate-app"] = "Firebase App named '{$appName}' already exists", V["app-deleted"] = "Firebase App named '{$appName}' already deleted", V["invalid-app-argument"] = "firebase.{$appName}() takes either no argument or a Firebase App instance.", V["invalid-log-argument"] = "First argument to `onLog` must be null or a function.", V),
        U = new m("app", "Firebase", V),
        M = "@firebase/app",
        W = "[DEFAULT]",
        G = ((V = {})[M] = "fire-core", V["@firebase/analytics"] = "fire-analytics", V["@firebase/auth"] = "fire-auth", V["@firebase/database"] = "fire-rtdb", V["@firebase/functions"] = "fire-fn", V["@firebase/installations"] = "fire-iid", V["@firebase/messaging"] = "fire-fcm", V["@firebase/performance"] = "fire-perf", V["@firebase/remote-config"] = "fire-rc", V["@firebase/storage"] = "fire-gcs", V["@firebase/firestore"] = "fire-fst", V["fire-js"] = "fire-js", V["firebase-wrapper"] = "fire-js-all", V),
        $ = new H("@firebase/app"),
        Y = (Object.defineProperty(K.prototype, "automaticDataCollectionEnabled", {
            get: function() {
            ...
            return void 0 === t && (t = W), this.checkDestroyed_(), this.container.getProvider(e).getImmediate({
                identifier: t
            })
    ...
    function Z(l) {
        var c = {},
            ...
            p = {
                ...
                initializeApp: function(e, t) {
                    ...
                    t = r.name;
                    if ("string" != typeof t || !t) throw U.create("bad-app-name", {
                        appName: String(t)
                    });
                    if (b(c, t)) throw U.create("duplicate-app", {
                        appName: t
                    });
                    r = new l(e, r, p);
                    return c[t] = r
                ...
                registerVersion: function(e, t, r) {
                    ...
                    if (i || e) {
                        ...
                        return i && r.push('library name "' + n + '" contains illegal characters (whitespace or "/")'), i && e && r.push("and"), e && r.push('version name "' + t + '" contains illegal characters (whitespace or "/")'), void $.warn(r.join(" "))
                    }
                    o(new I(n + "-version", function() {
                        return {
                            library: n,
                            version: t
                        }
        ...
        function f(e) {
            if (!b(c, e = e || W)) throw U.create("no-app", {
                appName: e
            });
            return c[e]
        }
        ...
        function o(r) {
            var t, e, n, i = r.name;
            if (u.has(i)) return $.debug("There were multiple attempts to register component " + i + "."), "PUBLIC" === r.type ? p[i] : null;
            u.set(i, r), "PUBLIC" === r.type && (n = function(e) {
                if (void 0 === e && (e = f()), "function" != typeof e[i]) throw U.create("invalid-app-argument", {
                    appName: i
                });
                return e[i]()
            }, void 0 !== r.serviceProps && d(n, r.serviceProps), p[i] = n, l.prototype[i] = function() {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    ...
    var V = function e() {
            var t = Z(Y);
            return t.INTERNAL = o(o({}, t.INTERNAL), {
        ...
        q = (Q.prototype.getPlatformInfoString = function() {
    ...
    var ee, te, re = V;
    (ee = re).INTERNAL.registerComponent(new I("platform-logger", function(e) {
        return new q(e)
    }, "PRIVATE")), ee.registerVersion(M, "0.6.13", te), ee.registerVersion("fire-js", "");
