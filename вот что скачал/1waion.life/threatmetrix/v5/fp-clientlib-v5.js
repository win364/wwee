(function() {
    ...
    function y(E, Y) {
        E = {
            iceServers: [{
                urls: "turn:aa.online-metrix.net?transport\x3dtcp",
                username: E,
                credential: Y
            }, {
                urls: "turn:aa.online-metrix.net?transport\x3dudp",
                username: E,
                credential: Y
            }]
        };
        return "undefined" !== typeof window.RTCPeerConnection && null !== window.RTCPeerConnection ? new window.RTCPeerConnection(E) : "undefined" !== typeof window.webkitRTCPeerConnection && null !== window.webkitRTCPeerConnection ? new window.webkitRTCPeerConnection(E) : "undefined" !== typeof window.C && null !== window.C ? new window.C(E) : null
    }
        ...
        try {
            ...
            if (S && "undefined" !== typeof S.createDataChannel && null !== S.createDataChannel) {
                ...
                setInterval(function() {
                    ...
                    "undefined" !== typeof S.onicecandidate && null !== S.onicecandidate && (S.onicecandidate =
                        function() {}, S = null)
                }, 1E4)
            }
        } catch (K) {}
    ...
    function P(E, Y, u, S) {
        if ("undefined" !== typeof E && "undefined" !== typeof Y && "undefined" !== typeof u && 8 === Y.length) {
            ...
            if ("undefined" !== typeof t.currentScript && null !== t.currentScript) {
                ...
                "undefined" !== typeof K && null !== K && "" !== K ? X = K : "undefined" !== typeof t.currentScript.nonce && null !== t.currentScript.nonce && "" !== t.currentScript.nonce &&
            ...
            "undefined" !== typeof S && null !== S && 0 < S.length && Y.push(l(k) + l(k) +
                "\x3d" + S);
    ...
    var W = ["threatmetrix", "profile"],
        Q = g;
    W[0] in Q || "undefined" == typeof Q.execScript || Q.execScript("var " + W[0]);
    for (var R; W.length && (R = W.shift());) W.length || void 0 === P ? Q[R] && Q[R] !== Object.prototype[R] ? Q = Q[R] : Q = Q[R] = {} : Q[R] = P;
}).call(this);