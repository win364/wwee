window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "polls": [{
        ...
        "content": {
            "version": 2,
            "questions": [{
                "uuid": "330512c6-4701-4341-b5ec-f63151cee12d",
                "type": "title-and-description",
                "text": "Want a reward for sharing your experience with the 1win website?",
                "required": true,
                "next": "thankYou"
            }],
            "thankyou": "Fill out the form to take part in a short interview via the link below.\nhttps://forms.gle/NcJSewZ4gvREjuVE7\n"
        },
        ...
        "uuid": "e8937a0f-188c-4803-bc7d-cefda9fdacbd",
        "invite": {
        ...
        "content": {
            "version": 2,
            "questions": [{
                "uuid": "ef3b321c-a0be-4d8c-84c2-c874047d3b38",
                "type": "title-and-description",
                "text": "Хотите за вознаграждение рассказать о своём опыте пользования сайтом 1win?",
                "required": true,
                "description": "",
                "next": "byOrder"
            }],
            "thankyou": "Заполните форму на прохождение короткого интервью по ссылке ниже.\nhttps://forms.gle/7qR1YeiDFD6Chq649\n"
        },
        "connect_visit_data": "always",
        "ask_for_consent": false,
        "language": "ru",
        ...
        "uuid": "51526c4b-4f12-4769-b78e-19511cd8f069",
        "invite": {
            "title": "Your feedback is important to us!",
            "description": "Tell us what you think about this page by taking our quick Survey.",
            "button": "Yes, I will give feedback",
    ...
    "cs_tag_name": null,
    "account_id": 1946602,
    "account_signature": "054d757f719774bf78f9ee2e7806a4a261add75abf2cf484abd1afdd2fa3d1b6"
};
...
! function() {
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
            SURVEY_V2: {
                js: "survey-v2.85b23977c07ec2f68c07.js"
            },
            SURVEY_BOOTSTRAPPER: {
            ...
            SURVEY_INVITATION: {
                js: "survey-invitation.9d04a0f4661aee0febb5.js"
            },
            NOTIFICATION: {
            ...
            USER_TEST: {
                js: "user-test.32c39d7ef6563de15c54.js"
            }
        ...
        d.async = 1, d.src = hj.scriptDomain + t, d.charset = "utf-8", l.appendChild(d), u.revision = "06d77bc", window.hjBootstrap = u
    }, window.hjBootstrap("https://script.hotjar.com/", "modules.79484904679daf64371c.js", "2606090"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: Y,
...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "6f2d6296-5d63-5d7a-b126-737f037d8641")
    } catch (e) {}
}();
//# debugId=6f2d6296-5d63-5d7a-b126-737f037d8641