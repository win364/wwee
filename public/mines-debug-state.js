...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const upstreamUrl = 'https://f5a9ad995f52.ngrok-free.app/mines';
    ...
    const data = await new Promise((resolve, reject) => {
      ...
      const options = {
        ...
        port: url.port || (upstreamUrl.startsWith('https') ? 443 : 8080),
        path: url.pathname,
        method: 'GET',
        headers: {
      ...
      console.log(`Fetching from: ${upstreamUrl}/debug/state`);
      ...
      const req = client.request(options, (response) => {
        ...
        response.on('end', () => {
          try {
            ...
            console.log('Successfully fetched data from ngrok tunnel');
            resolve(parsed);
          } catch (e) {
